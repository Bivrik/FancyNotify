...
public class RecipeNotification extends ExpandableNotification {
    private static final Identifier BACKGROUND = Identifiers.of("notifications/recipe");
    ...
    public RecipeNotification(NotificationManager manager, RecipeDisplay recipe) {
